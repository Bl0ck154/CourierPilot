...
enum class MarketConfidence { NOT_READY, LOW, MEDIUM, HIGH }
...
data class MarketScreenState(
    ...
    val confidence: MarketConfidence = MarketConfidence.NOT_READY,
