 ...
 *
 * This class owns capture-session data and frame/proof accumulation, not capture policy.
 * Accessibility probing, disclosure clicks, OCR retries, route publication and persistence
 * decisions remain in [OfferAccessibilityService].
 */
